...
/// Step 2: Triage incomplete tasks
struct ReviewIncompleteStep: View {
    ...
    private var emptyStateView: some View {
        VStack(spacing: Constants.Spacing.lg) {
            ...
            Text("You don't have any incomplete tasks to review.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
    ...
    private var allDoneView: some View {
        VStack(spacing: Constants.Spacing.lg) {
            ...
            Text("You've reviewed all incomplete tasks.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
    ...
    // MARK: - Task Card
    private func taskCardView(_ task: TaskEntity) -> some View {
    ...
    // MARK: - Action Buttons
    private func actionButtonsView(_ task: TaskEntity) -> some View {
